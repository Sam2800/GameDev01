...
[System.Serializable] public class AIObjects
{
    ...
    [SerializeField] [Range(0f, 30f)] private int m_maxAI;
    [SerializeField] [Range(0f, 20f)] private int m_spawnRate;
    [SerializeField] [Range(0f, 10f)] private int m_maxSpawnAmount;
...
public class AISpawner : MonoBehaviour
{
    ...
    [SerializeField] private Color m_SpawnerColor = new Color(1.000f, 0.000f, 0.300f);
    ...
    {
        Vector3 randomPosition = new Vector3 (Random.Range(-spawnArea.x, spawnArea.x), Random.Range(-spawnArea.x, spawnArea.y), Random.Range(-spawnArea.x, spawnArea.z));
